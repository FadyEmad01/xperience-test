        ...
        <HoverCard>
            <HoverCardTrigger asChild>
                <img
                    src={user.image}
                    alt={user.name}
                    className="size-6 rounded-full ring-1 ring-background relative z-0 transition-all duration-300 hover:z-20 hover:scale-105 object-cover"
                />
            </HoverCardTrigger>

            <HoverCardContent sideOffset={10} className="z-30 bg-background/20 backdrop-blur-2xl">
                <div className="space-y-3">
                    <div className="flex items-center gap-3">
                        <img
                            src={user.image}
...
function HeroHeader({
    ...
    return (
        <>
            {/* className="mt-8 text-[2.4rem] sm:text-[3rem] md:text-[4.8rem] leading-[100%] tracking-[-0.01em] text-center mb-4 pb-3 text-balance effect-font-hero effect-font-gradient effect-font-styling" */}
            <h1 className="mt-6 text-[2.4rem] sm:text-[3rem] md:text-[4.8rem] ltr:leading-[1.1] ltr:sm:leading-[1.05] leading-tight tracking-[-0.005em] md:tracking-[-0.01em] text-center mb-3 text-balance effect-font-hero effect-font-gradient effect-font-styling">
                {title}
            </h1>
            {/* <h2 className="mx-auto mt-8 max-w-2xl text-balance text-lg text-text-secondary"> */}
            <h2 className="mx-auto mt-4 max-w-xl text-balance  text-sm sm:text-[1rem] md:text-lg text-text-secondary">
                {description}
            </h2>
        </>
    );
